...
"draggable","droppable","resizable","pagination",'cqmenus','menus',"input",
"menubutton","tree","layout","panel","datagrid"
,"tabs","window","dialog"],
parse:function(_c){
var aa=[];
...
parseOptions:function(id,_16){
	var t=$(id);
	var _17={};
	var dataSet = t.attr("data-options") ? t.attr("data-options") : t.attr("cq-data");
	var s=$.trim(dataSet) ;
	if(s){
	if(s.substring(0,1)!="{"){
	s="{"+s+"}";
...
$.fn._size=function(_1e,_1f){
	if(typeof _1e=="string"){
		...
		if(r1||r2){
		$(this).addClass("cq-layout-fluid");
		}else{
		$(this).removeClass("cq-layout-fluid");
		}
		});
	}
...
if($(this).hasClass("cq-layout-fluid")||_a8){
_8e(this);
}
return false;
});
...
(function($){
	...
	if($(this).hasClass("cq-layout-fluid")||_222){
	_211(_220);
	}
	return false;
	});
	...
	function _227(){
		//透明
		if(opts.transparent){
			_226.children(".panel-body").css('background-color','transparent');
		}
	...
	if(_25c.length){
	_25c.layout("resize");
	$("body").children(".cq-layout-fluid:visible").each(function(){
	...
	function _266(_267,type){
		...
		var s=$(_267).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.cq-layout-fluid:visible").filter(function(_269,el){
...
bb.insertAfter(_2a9);
tb.add(bb)._outerWidth(t._outerWidth()).find(".cq-layout-fluid:visible").each(function(){
$(this).triggerHandler("_resize");
});
...
if($(this).hasClass("cq-layout-fluid")||_2ea){
_2c9(_2e8);
}
return false;
});
...
p_t.find(".cq-layout-fluid:visible").triggerHandler("_resize");
};
};
function _33c(_33d){
...
if($(this).hasClass("cq-layout-fluid")||_345){
_330(_343);
_33c(_343);
}
return false;
...
(function($) {
    ...
    function _2(target, options) {
        var data = $.data(target, "layout");
        ...
        _9(_a(panels.expandNorth) ? panels.expandNorth : panels.top, "n");
        _9(_a(panels.expandSouth) ? panels.expandSouth : panels.bottom, "s");
        _b(_a(panels.expandEast) ? panels.expandEast : panels.right, "e");
        _b(_a(panels.expandWest) ? panels.expandWest : panels.left, "w");
        panels.center.panel("resize", _8);
    ...
    function _12(_13) {
        ...
        function _14(el) {
            ...
            if ("top,bottom,right,left,center".indexOf(_15.align) >= 0) {
                _19(_13, _15, el);
            }
        };
        ...
        cc.bind("_resize", function(e, _18) {
            if ($(this).hasClass("cq-layout-fluid") || _18) {
                _2(_13);
            }
            return false;
        });
    ...
    function _2d(_2e, _2f, _30) {
        ...
        function _34(dir) {
            ...
            var _39 = (_32.align == "top" || _32.align == "bottom");
            ...
            if (_2f == "right") {
                ...
                if (_2f == "left") {
                    ...
                    if (_2f == "top") {
                        ...
                        _31.right.add(_31.left).add(_31.expandEast).add(_31.expandWest).panel("resize", {
                            top: _3d - 1,
                            height: hh
                        });
                        return {
    ...
    $.fn.layout.methods = {
        ...
        add: function(jq, _5f) {
            return jq.each(function() {
                _19(this, _5f);
                _2(this);
                if ($(this).layout("panel", _5f.align).panel("options").collapsed) {
                    _2d(this, _5f.align, 0);
                }
            });
        },
    ...
    $.fn.layout.parsePanelOptions = function(_68) {
        var t = $(_68);
        return $.extend({}, $.fn.panel.parseOptions(_68), $.parser.parseOptions(_68, ["align", {
            split: "boolean",
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        ...
        collapsedContent: function(_69) {
            ...
            if (_6a.align == "top" || _6a.align == "bottom") {
                return _69;
            }
...
if($(this).hasClass("cq-layout-fluid")||_406){
...
menu.find(".cq-layout-fluid").triggerHandler("_resize",[true]);
...
if($(this).hasClass("cq-layout-fluid")||_478){
_479(_476);
}
return false;
});
...
if($(this).hasClass("cq-layout-fluid")||_508){
_4ec(_501);
}
return false;
});
...
if($(this).hasClass("cq-layout-fluid")||_5c2){
_5bd(_5c1);
}
return false;
});
